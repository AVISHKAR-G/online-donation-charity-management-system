...
import {
  Mail, Lock, LogIn, ShieldCheck, HeartHandshake, Users,
  ...
  useEffect(() => {
    ...
    function initGoogle() {
      ...
      window.google.accounts.id.renderButton(googleButtonRef.current, {
        theme: 'outline', size: 'large', width: 210, text: 'continue_with',
      });
    }
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .hc-marquee-track { animation: hc-marquee-scroll 26s linear infinite; }
        .hc-marquee-viewport:hover .hc-marquee-track { animation-play-state: paused; }
        ...
        .hc-modal-backdrop { animation: hc-backdrop-in 0.25s ease both; }
        .hc-modal-card { animation: hc-modal-in 0.3s ease both; }
      `}</style>

      <div style={{ display: 'flex', width: '100%', maxWidth: 1200, borderRadius: 24, overflow: 'hidden', alignItems: 'center', gap: 40, position: 'relative', zIndex: 1 }}>
        <div style={{
          flex: 1, padding: '20px 20px', display: 'flex', flexDirection: 'column', gap: 28,
          transition: 'opacity 0.25s ease', opacity: started ? 0.35 : 1,
        }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <FeatureRow icon={ShieldCheck} title="Trusted & Transparent" subtitle="100% transparency in every donation" />
            <FeatureRow icon={Users} title="Impact Driven" subtitle="Real change in communities" />
            <FeatureRow icon={Lock} title="Secure & Safe" subtitle="Your data and donations are safe" />
          </div>
        ...
        <div style={{ flex: 1, maxWidth: 480, position: 'relative', transition: 'opacity 0.25s ease', opacity: started ? 0.35 : 1 }}>
          <div
            className="hc-marquee-viewport"
            style={{
              height: 560, overflow: 'hidden', borderRadius: 24, position: 'relative',
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: '0 25px 70px rgba(0,0,0,0.35)', position: 'relative',
            }}
          >
            <button
              onClick={() => setStarted(false)}
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link to="/forgot-password" style={{ fontSize: 13, color: '#16a34a', fontWeight: 500 }}>
                  Forgot Password?
                </Link>
              </div>
            ...
            <p style={{ textAlign: 'center', fontSize: 14, color: '#6b7280', marginTop: 28 }}>
              ...
              <Link to="/register" style={{ color: '#16a34a', fontWeight: 600 }}>Register</Link>
            </p>
          </div>
        </div>
      )}
...
function FeatureRow({ icon: Icon, title, subtitle }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
      <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(220,252,231,0.9)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
