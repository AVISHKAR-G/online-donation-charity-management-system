...
import { User, Mail, Phone, Lock, UserPlus, ShieldCheck, HeartHandshake, Users } from 'lucide-react';
        ...
        <div style={{ flex: 1, padding: '20px 20px', display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          <div>
            <h1 style={{ fontSize: 38, fontWeight: 800, lineHeight: 1.2, color: '#111827', margin: 0 }}>
              Join Us And<br />
              <span style={{ color: '#2563eb' }}>Start Giving Back</span>
            </h1>
...
function HandsHeartIllustration() {
  return (
    <svg width="320" height="300" viewBox="0 0 320 300" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M60 260 C 20 220, 30 140, 90 110 C 130 90, 160 60, 150 20 C 220 40, 260 100, 250 170 C 245 220, 210 260, 160 260 Z"
        fill="#dbeafe"
        opacity="0.6"
      />
      ...
      <path
        d="M100 260 C95 230 100 210 120 200 C130 195 145 195 155 205 L160 245 C160 255 150 265 135 265 L110 265 C104 265 101 263 100 260Z"
        fill="#f4a89f"
      />
      <path
        d="M220 260 C225 230 220 210 200 200 C190 195 175 195 165 205 L160 245 C160 255 170 265 185 265 L210 265 C216 265 219 263 220 260Z"
        fill="#f4a89f"
      />
      <path
        d="M160 200 c0-11 -9-19.5 -19.5-19.5 -6.3 0-11.9 3-15.3 7.8 -3.5-4.8-9-7.8-15.3-7.8 -10.5 0-19.5 8.5-19.5 19.5 0 16.7 18.8 27.9 34.8 40.4 16-12.5 34.8-23.7 34.8-40.4Z"
        fill="#3b82f6"
